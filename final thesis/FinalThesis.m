...
out = sim('PropGlycAdjustedARNoNoiseNew.slx',8000); 
...
sampleTime = out.tout;
clear out
out = sim('PropGlycAdjustedARNew.slx',8000); % Run Simulation with Noise
...
clear out
out = sim('PropGlycAdjustedARNoNoiseNew.slx',duration); 
...
clear out 
out = sim('PropGlycAdjustedARNew.slx',duration); % Run Simulation with Noise
